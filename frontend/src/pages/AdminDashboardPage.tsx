...
import {api} from '../api'
import type {OperationsReport,UserStats} from '../types'
...
export default function AdminDashboardPage(){
  ...
  useEffect(()=>{
    Promise.all([api.adminUserStats(),api.adminOperationsReport()])
      .then(([users,operations])=>{setStats(users);setReport(operations)})
  ...
  return <section className="page-section container admin-page">
    ...
    <p className="page-lead">Theo dõi tài khoản, doanh thu và tình trạng vận hành nhà hàng.</p>
