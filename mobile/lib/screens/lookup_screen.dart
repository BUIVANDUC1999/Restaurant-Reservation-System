...
class _LookupScreenState extends State<LookupScreen> {
  ...
  Future<void> lookup() async {
    ...
    try {
      final value =
          await widget.api.lookup(code.text.trim(), phone.text.trim());
  ...
  Widget build(BuildContext context) =>
      ListView(padding: const EdgeInsets.all(20), children: [
        ...
        FilledButton.icon(
            ...
            label: const Padding(
                padding: EdgeInsets.all(13), child: Text('Tra cứu'))),
        if (error != null)
          Padding(
              ...
              child: Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            'Lịch: ${result!.reservationDate} lúc ${result!.reservationTime}'),
                        Text('Thời lượng: ${result!.durationMinutes} phút'),
                        Text(
                            'Bàn: ${result!.tableCodes.isEmpty ? 'Chờ xếp bàn' : result!.tableCodes.join(', ')}'),
