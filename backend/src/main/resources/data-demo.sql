...
('Thắng cố vùng cao', 'Đặc sản', 220000, 'Hương vị đặc trưng vùng cao, nấu cùng thảo quả và gia vị Tây Bắc.', 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=1000&q=80', TRUE, TRUE),
('Lẩu cá hồi Tây Bắc', 'Lẩu', 650000, 'Cá hồi tươi, nước lẩu chua cay và rau bản địa theo mùa.', 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=1000&q=80', TRUE, TRUE),
...
('Ngọn su su xào tỏi', 'Món hàng ngày', 90000, 'Rau su su vùng cao xanh giòn, xào nhanh cùng tỏi thơm.', 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
...
('Cá tầm rang muối', 'Đặc sản', 360000, 'Cá tầm vùng cao rang muối giòn thơm, dùng cùng rau răm.', 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?auto=format&fit=crop&w=1000&q=80', TRUE, TRUE);
...
('Cá hồi nướng giấy bạc', 'Cá hồi', 420000, 'Cá hồi vùng cao nướng cùng nấm, rau thơm và sốt bơ tỏi.', 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?auto=format&fit=crop&w=1000&q=80', TRUE, TRUE),
('Gỏi cá hồi Tây Bắc', 'Cá hồi', 260000, 'Cá hồi tươi thái lát dùng cùng rau bản và mù tạt.', 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
...
('Lẩu cá tầm Tây Bắc', 'Lẩu', 780000, 'Cá tầm tươi, nước dùng chua thanh và rau theo mùa.', 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?auto=format&fit=crop&w=1000&q=80', TRUE, TRUE),
...
('Nấm hương Tây Bắc xào', 'Món hàng ngày', 110000, 'Nấm hương bản địa xào rau củ, vị thanh nhẹ.', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
...
('Mầm đá xào bò', 'Đặc sản', 180000, 'Mầm đá vùng cao xào thịt bò mềm và tỏi bản.', 'https://images.unsplash.com/photo-1540420773420-3366772f4999?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
...
('Nem cá hồi', 'Khai vị', 160000, 'Nem chiên nhân cá hồi vùng cao, dùng cùng rau sống.', 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
...
('Bánh ngô Tây Bắc', 'Khai vị', 60000, 'Bánh ngô vàng thơm, áp chảo nhẹ và dùng nóng.', 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE),
('Chè ngô nếp Tây Bắc', 'Tráng miệng', 55000, 'Chè ngô nếp dẻo thơm, vị ngọt nhẹ dùng sau bữa ăn.', 'https://images.unsplash.com/photo-1551024506-0bccd828d307?auto=format&fit=crop&w=1000&q=80', FALSE, TRUE);
